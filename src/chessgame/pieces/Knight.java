 ...
 * for the Knight's algebraic letter and Unicode icons.
 */
public class Knight extends Piece {
	
    /**
     * Constructs a Knight piece with the specified board coordinates and color.
    ...
    /**
     * Constructs a Knight piece using integer coordinates and color.
    ...
    /**
     * Constructs a Knight piece restoring its state from a packed information byte.
    ...
    /**
     * Retrieves the Unicode icon representing this Knight, specific to its color.
     * * @return A string containing the Unicode character for the Knight.
     */
    ...
    /**
     * Retrieves a neutral Unicode icon representing a Knight, regardless of its color.
     * Typically used for GUI representations where color is determined by the component's foreground.
     * * @return A string containing the solid Unicode character for the Knight.
     */
    ...
    /**
     * Retrieves the standard algebraic notation letter for the Knight.
