...
/**
 * Factory class responsible for creating and initializing {@link ChessBoard} objects.
 * It provides methods to generate a standard chess board setup or to load a specific
 * board state from a valid FEN (Forsyth-Edwards Notation) string.
 */
public class BoardFactory {
    
    /**
     * Creates a new ChessBoard initialized with the standard starting position of a chess game.
     * * @return A fully populated {@link ChessBoard} ready for a new game.
     */
    ...
    /**
     * Constructs a ChessBoard state from a given FEN string.
     * Parses piece placement, active color, castling rights, and en passant targets.
     * * @param fen The FEN string representing the desired board state.
     * @return A {@link ChessBoard} initialized to the exact state described by the FEN.
     * @throws InvalidFENexception If the provided FEN string is malformed or contains invalid data.
     */
    ...
    /**
     * Generates the initial set of Rooks for the specified color.
     * * @param matrix  The 2D board array where pieces are placed.
     * @param isWhite True to generate white Rooks, false for black Rooks.
     * @return An ArrayList containing the generated {@link Rook} objects.
     */
    ...
    /**
     * Generates the initial set of Pawns for the specified color.
     * * @param matrix  The 2D board array where pieces are placed.
     * @param isWhite True to generate white Pawns, false for black Pawns.
     * @return An ArrayList containing the generated {@link Pawn} objects.
     */
    ...
    /**
     * Generates the initial set of Knights for the specified color.
     * * @param matrix  The 2D board array where pieces are placed.
     * @param isWhite True to generate white Knights, false for black Knights.
     * @return An ArrayList containing the generated {@link Knight} objects.
     */
    ...
    /**
     * Generates the initial set of Bishops for the specified color.
     * * @param matrix  The 2D board array where pieces are placed.
     * @param isWhite True to generate white Bishops, false for black Bishops.
     * @return An ArrayList containing the generated {@link Bishop} objects.
     */
    ...
    /**
     * Generates the initial Queen for the specified color.
     * * @param matrix  The 2D board array where pieces are placed.
     * @param isWhite True to generate a white Queen, false for a black Queen.
     * @return An ArrayList containing the generated {@link Queen}.
     */
    ...
    /**
     * Generates the initial King for the specified color.
     * * @param matrix  The 2D board array where pieces are placed.
     * @param isWhite True to generate a white King, false for a black King.
     * @return The generated {@link King} object.
     */
